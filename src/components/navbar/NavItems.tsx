      ...
      <Collapse in={open}>
        <Box sx={{ mb: 0.5 }}>
          ...
          {item.megaMenu && item.megaMenu.type === MegaMenuType.MEGAMENU3 && (
            <MegaMenu3 {...{ ...{ ...item.megaMenu, footerData: item.megaMenu.footerData as ReactElement }, footerSX }} />
          )}
          {item.megaMenu && item.megaMenu.type === MegaMenuType.MEGAMENU4 && (
            <MegaMenu4 {...{ ...{ ...item.megaMenu, footerData: item.megaMenu.footerData as ReactElement }, footerSX }} />
          )}
          {item.megaMenu && item.megaMenu.type === MegaMenuType.MEGAMENU5 && (
            <MegaMenu5 {...{ ...{ ...item.megaMenu, bannerData: item.megaMenu.bannerData as ReactElement }, footerSX }} />
          )}
        </Box>
      </Collapse>
    </>
