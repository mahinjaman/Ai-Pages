...
export default function Blog2({ heading, caption, blogs }: BlogProps) {
            ...
            {blogs.map((item, index) => (
              <Box key={index} sx={{ px: 0.75 }}>
                <GraphicsCard
                  ...
                  overLay={`linear-gradient(360deg, ${alpha(theme.palette.grey[900], 0.5)} 0%, ${alpha(theme.palette.mode === ThemeMode.DARK ? theme.palette.grey[200] : theme.palette.primary.darker, theme.palette.mode === ThemeMode.DARK ? 0.5 : 0)} 100%)`}
                >
                  <Stack
