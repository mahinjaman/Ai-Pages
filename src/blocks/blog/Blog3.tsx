...
export default function Blog3({ heading, caption, blogs }: BlogProps) {
          ...
          {blogs.map((item, index) => (
            <Grid key={index} size={{ xs: 12, sm: 6 }}>
              ...
              >
                <GraphicsCard>
                  <GraphicsCard>
                    <GraphicsImage image={item.image as ImageCommonProps} sx={{ height: { xs: 250, md: 326 }, ...item.imagePosition }} />
                  </GraphicsCard>
