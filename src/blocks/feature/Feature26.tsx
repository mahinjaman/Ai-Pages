...
interface Props {
  ...
  feature3: { title: string; content: string };
}

/***************************  FEATURE - MOTION WRAP  ***************************/

function MotionWrap({ delay, children }: { delay: number; children: ReactNode }) {
  return (
    <motion.div
...
export default function Feature26({ headLine, captionLine, feature1, feature2, feature3, avatarList }: Props) {
